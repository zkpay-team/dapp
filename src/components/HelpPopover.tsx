  ...
  return (
    <div className='absolute -right-2 md:right-2 -top-2.5'>
      ...
      <div
        ...
        } right-2 top-14 absolute z-10 inline-block text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-greeny rounded shadow-sm w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400`}>
