            ...
            <div className='p-6 space-y-6'>
              {!isProposalUseEth && (
                <nav className='mb-8'>
                  <ol
                    role='list'
                    className='divide-y divide-gray-200 rounded border border-greeny md:flex md:divide-y-0'>
                  ...
                  {tokenBalance && (
                    <div className='flex justify-between w-full'>
                      ...
                      <p className=''>
                        <span
                          className={`block ${
                            hasEnoughBalance() ? 'bg-greeny' : 'bg-red-500'
            ...
            <div className='flex items-center p-6 space-x-2 rounded-b border-t border-greeny '>
              {hasEnoughBalance() ? (
                <button
                  onClick={() => onSubmit()}
                  type='button'
                  className='hover:text-green-600 hover:bg-green-50 bg-greeny text-white rounded px-5 py-2.5 text-center'>
                ...
                <button
                  disabled
                  type='button'
                  className='hover:text-red-600 hover:bg-red-50 bg-red-500 text-white rounded px-5 py-2.5 text-center'>
                  Validate proposal
                </button>
              )}
              <button
