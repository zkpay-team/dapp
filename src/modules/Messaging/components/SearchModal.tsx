...
function SearchModal() {
  ...
  const handleChat = () => {
    const chatLink = `https://www.zk-pay.io/messaging/${search}`;
  ...
  return (
    <>
      <button
        type='button'
        className=' hover:bg-endnight text-white bg-endnight px-3 py-2 text-sm flex items-center mr-4'
        onClick={() => setShow(true)}>
        <SearchOutline className='w-[18px] h-[18px] text-greeny mr-2' />
        Search
      </button>
